...
public class Rect extends Shape {
	 ...
	 private final RoundRectangle2D shape = new RoundRectangle2D();
	     ...
	     */
	    public Rect(int width, int height, Paint fill) {
	        setWidth(width);
	        setHeight(height);
	        setFill(fill);
	    }
	     ...
	     * @defaultValue 0.0
	     */
	    private final IntegerProperty width = new IntegerPropertyBase() {
	     ...
	     * @defaultValue 0.0
	     */
	    private final IntegerProperty height = new IntegerPropertyBase() {
	     ...
	     * @defaultValue 0.0
	     */
	    private IntegerProperty arcWidth;


	    public final void setArcWidth(int value) {
	        if (arcWidth != null || value != 0) {
	            arcWidthProperty().set(value);
	        }
	    }

	    public final int getArcWidth() {
	        return arcWidth == null ? 0 : arcWidth.get();
	    }

	    public final IntegerProperty arcWidthProperty() {
	        if (arcWidth == null) {
	            arcWidth = new StyleableIntegerProperty() {
	     ...
	     * @defaultValue 0.0
	     */
	    private IntegerProperty arcHeight;


	    public final void setArcHeight(int value) {
	        if (arcHeight != null || value != 0) {
	            arcHeightProperty().set(value);
	        }
	    }

	    public final int getArcHeight() {
	        return arcHeight == null ? 0 : arcHeight.get();
	    }

	    public final IntegerProperty arcHeightProperty() {
	        if (arcHeight == null) {
	            arcHeight = new StyleableIntegerProperty() {
	     ...
	     **************************************************************************/
	     ...
	     private static class StyleableProperties {
	         private static final CssMetaData<Rect,Number> ARC_HEIGHT =
	            new CssMetaData<Rect,Number>("-fx-arc-height",
	                SizeConverter.getInstance(), 0.0) {

	            @Override
	            public boolean isSettable(Rect node) {
	                return node.arcHeight == null || !node.arcHeight.isBound();
	            }

	            @Override
	            public StyleableProperty<Number> getStyleableProperty(Rect node) {
	                return (StyleableProperty<Number>)node.arcHeightProperty();
	            }

	        };
	         private static final CssMetaData<Rect,Number> ARC_WIDTH =
	            new CssMetaData<Rect,Number>("-fx-arc-width",
	                SizeConverter.getInstance(), 0.0) {
